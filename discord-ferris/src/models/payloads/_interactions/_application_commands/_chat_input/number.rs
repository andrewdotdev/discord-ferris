...
pub struct APIApplicationCommandNumberOptionBase {
    #[serde(flatten)]
...
pub type APIApplicationCommandNumberOption =
    APIApplicationCommandOptionWithAutocompleteOrChoicesWrapper<
        APIApplicationCommandNumberOptionBase,
        APIApplicationCommandOptionChoice<f64>,
    >;
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct APIApplicationCommandInteractionDataNumberOption<Type = InteractionType> {
    #[serde(flatten)]
    pub base: APIInteractionDataOptionBase<NumberOptionValue, ApplicationCommandOptionType>,
